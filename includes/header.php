...
?>   
   ...
   <?php   if(strlen($_SESSION['login'])==0)
	{	
?>
 <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">User Login / Register</a> 

</div>
<div class="login_btn"> <a href="admin/" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Admin Login</a> 
